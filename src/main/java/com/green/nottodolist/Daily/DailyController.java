...
public class DailyController {
    ...
    @PutMapping()@Operation(summary = "입력값 수정",description = "useListId: PK값, <br>"+"cost: 소비비용, <br>"+"cost값이 0일 경우 삭제처리와 같음")
    public int PatchDaily(@RequestBody DailyUpdDto dto){return service.UpdDaily(dto);}

    @GetMapping@Operation(summary = "그 날의 전체 항목 행위를 했든 안했든 모든 항목들을 출력",description = "date = YYYY-MM-DD")
    ...
    @DeleteMapping@Operation(summary = "입력한 값 삭제",description = "useListId: PK값")
